...
{
    partial class АккаунтАдминистратора
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "АккаунтАдминистратора";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Load += new System.EventHandler(this.АккаунтАдминистратора_Load);
